<template>
  <nav class="sticky top-0 z-30 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 shadow-sm backdrop-blur-sm transition-all duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        ...
        <RouterLink to="/" class="flex items-center gap-2 group">
          ...
          <span class="text-xl font-bold tracking-tight text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
            MyStore
          </span>
        </RouterLink>
        ...
        <div class="flex items-center gap-2 sm:gap-4">
          ...
          <button
            @click="toggleDark()"
            class="relative group p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-300"
          ...
          <div v-if="authStore.isLoggedIn" class="hidden sm:flex items-center gap-3 px-3 py-1.5 rounded-lg bg-gray-100 dark:bg-gray-800">
          ...
          <button
            ...
            class="px-4 py-2 rounded-lg text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-300 flex items-center gap-2"
          >
